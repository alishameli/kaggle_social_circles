...
/**
 * Class providing some general purpose kernels: linear, polynomial, Gaussian
 * (RBF) and tanh (sigmoid)
 * 
 * @author miafranc
 * 
 */
public class Kernel {
	 ...
	 */
	public static double kPoly(FeatureNode[] x, FeatureNode[] z, double a,
			double b, double c) {
		if (c == 1.0)
	 ...
	 */
	public static double kGaussian(FeatureNode[] x, FeatureNode[] z,
			double sigma) {
	 ...
	 */
	public static double kTanh(FeatureNode[] x, FeatureNode[] z, double a,
			double b) {
